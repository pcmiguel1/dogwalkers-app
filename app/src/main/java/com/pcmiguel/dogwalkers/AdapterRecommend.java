...
public class AdapterRecommend extends RecyclerView.Adapter<AdapterRecommend.ViewHolder> {
    ...
    public AdapterRecommend (List<Walker> walkerList) {
        this.walkerList = walkerList;
    }

    @NonNull
    @Override
    public AdapterRecommend.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterRecommend.ViewHolder holder, int position) {
